...
- **Анна Ковалёва** — forensics expert (remote, координирует incident response)
...
**Анна Ковалёва** (голос напряжённый, задыхается):
...
[⬅ Episode 11: Disk Management](../episode-11-disk-management-lvm/README.md) | [Season 4: DevOps & Automation →](../../season-04-devops-automation/README.md)
