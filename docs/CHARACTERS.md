...
**Функция:**
- `s03e10`–`s03e11`: подключается на монтировании и резервных копиях
- `s03e12`–`s03e13`: ведущий наставник — ротация журналов, восстановление и его проверка
...
**Появление:** упоминается в `s04e08`, разбор — `s08e09`–`s08e10`
...
**Появление:** `s06e01`–`s06e07`, `s06e10`–`s06e12`
...
**Возраст:** 38 лет
**Национальность:** Исландец
**Роль:** Инженер по производительности, фон — высокопроизводительные вычисления
**Появление:** `s07e08`–`s07e10`

**Функция:**
Ведёт блок измерения: метод USE, поиск узкого места, перцентили по гистограмме,
тюнинг ядра, обоснованный замером. Настаивает, что параметр без измерения —
суеверие.

**Цитата:**
> *«Каждая миллисекунда важна — не потому, что её замечают, а потому, что она складывается».*

---

### Сигрид Эйнарсдоуттир
**Возраст:** 41 год
**Национальность:** Исландка
**Роль:** Инженер по безопасности, CERT Iceland
**Появление:** `s07e11`, `s08e01`–`s08e12`

**Функция:**
В Season 7 ведёт SELinux и ограничение прав контура. В Season 8 — разбор
инцидента: от первой волны до приёмки, включая границы активных действий
...
**Архитектор (личность):** Кирилл Соболев. Раскрыт и задержан в `s08e10`.
...
канон закрыт). Арестован в Санкт-Петербурге (день 59 операции, `s08e10`).
