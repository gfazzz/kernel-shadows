#!/usr/bin/env bash
#
# s01e04 «Детектив и автоматизация» — воспроизводимый unit-тест (fixture/TEST_ROOT, без root).
...
echo "════════════════════════════════════════════════════════════"
echo " s01e04 tests — subject: ${SCRIPT#"$SERIES_DIR"/}"
echo "════════════════════════════════════════════════════════════"

# Фикстура: файлы на РАЗНОЙ глубине — проверяем рекурсию find.
TEST_ROOT="$(mktemp -d 2>/dev/null || mktemp -d -t s01e04)"
