...
**Статус:** 🚧 рефакторинг v2.0 в работе — Seasons 1–6 пересобраны в атомарные серии
и покрыты воспроизводимыми тестами; Seasons 7–8 пока в исходном виде.
...
**Итого: 77 серий, `make check` зелёный.**
