...
рефакторинг; генерируемый — не может (§4.7 [плана](V2.0_UPGRADE_PLAN.md)).
...
Время получено обходом шапок всех серий, а не назначено на глаз (§4.12 плана).

---

## Хронометраж по сезонам

Получен обходом шапок серий (§4.12 плана), а не назначен на глаз. Прежняя
