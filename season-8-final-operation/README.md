...
- **Анна Ковалёва** — defensive security, forensics (Цюрих)
...
## 📚 ЭПИЗОДЫ (4 эпизода — структурно на месте; тесты требуют воспроизводимого харнесса v2.0)

### Episode 29: Начало бури (День 57) ✅
**Статус:** 🚧 v0.8.x — тест привязан к live-host (невоспроизводим на чистой машине; чинится в v2.0) | **Размер:** ~3,000 строк | **Тесты (live-host):** 33/33
...
**Статус:** 🚧 v0.8.x — тест live-host, проходит на 83% (невоспроизводимо; чинится в v2.0) | **Размер:** ~2,500 строк | **Тесты (live-host):** 29+/35 (83%)
...
**Статус:** 🚧 v0.8.x — тест live-host, проходит на 60%+ (невоспроизводимо; чинится в v2.0) | **Размер:** ~2,500 строк | **Тесты (live-host):** 24+/40 (60%+)
...
**Статус:** 🚧 v0.8.x — тест live-host, проходит на 70%+ (невоспроизводимо; чинится в v2.0) | **Размер:** ~1,700 строк | **Тесты (live-host):** 10+/14 (70%+)
...
- **Структурно готовы:** ✅ All 4 episodes (тесты — воспроизводимость в v2.0)
...
**Команда (27 людей):**
- Start: strangers
- End: brothers/sisters in arms (8 стран, одна цель)
...
**4 episodes. ~10,000 строк. Структурно на месте; воспроизводимость тестов — в v2.0.**
