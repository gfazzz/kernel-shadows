...
**Версия:** 2.0.0 · предыдущая линия — в ветке `archive/main-pre-v2.0`
...
доступно в ветке `archive/main-pre-v2.0`.
...
- [x] Полировка и выпуск v2.0 — план исполнен целиком
...
**Что дальше:** вычитка подряд глазами студента и обкатка на читателях —
то, чего не заменит ни одна автоматическая проверка.
