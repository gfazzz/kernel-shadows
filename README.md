...
Открытые долги — в [STATUS.md](docs/STATUS.md) и [V2.0_UPGRADE_PLAN.md](docs/V2.0_UPGRADE_PLAN.md).
...
- [x] Полировка и тег `v2.0.0` — план [исполнен целиком](docs/V2.0_UPGRADE_PLAN.md)
