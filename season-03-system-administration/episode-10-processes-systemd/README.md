...
```bash
cd /home/fazzz/kernel-shadows/season-03-system-administration/episode-10-processes-systemd/starter/systemd/
ls -la
# shadow-backup.service
# shadow-backup.timer
# shadow-monitor.service
...
```bash
cd /home/fazzz/kernel-shadows/season-03-system-administration/episode-10-processes-systemd
./tests/test.sh
```
