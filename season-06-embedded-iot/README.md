...
|-------|-------|---------|----------|------|--------|
| s06e01 | 21 | что это за плата: `/proc/cpuinfo`, device-tree, архитектура | `board_report.txt` | **C** | план |
| s06e02 | 21 | GPIO через sysfs: включить и не сжечь | `gpio_ctl.sh` | **A** | план |
