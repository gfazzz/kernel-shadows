...
| s07e02 | 25 | манифест Deployment: образ, ресурсы, проверки готовности и живости | `deployment.yaml` | **B** | план |
| s07e03 | 25 | как под находит других и откуда берёт настройки | `service.yaml` + `config.yaml` | **B** | план |
| s07e04 | 25 | застрявший выкат: почему обновление не едет | `rollout_check.sh` | **A** | план |
| s07e05 | 26 | экспортёр метрик: имена, типы, единицы, кардинальность | `check_metrics.sh` | **A** | план |
| s07e06 | 26 | правила Prometheus: `rate`, `for`, пороги | `rules.yml` | **B** | план |
