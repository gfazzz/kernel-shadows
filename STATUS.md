...
**Season 2 недоразукрупнён.** Разбор 2026-08-01: исходного материала в S2 столько
же, что и в S1 (8510 строк против ~8300), а серий 9 против 14. Три темы с
практикой в исходниках — SSH-туннели `-L`/`-R`/`-D`, WireGuard, rate limiting —
свернулись в абзацы теории без задания и артефакта. Сезон достраивается до
13 серий **после** Season 3; разбор и список кандидатов — `V2.0_UPGRADE_PLAN.md` §8.1.
