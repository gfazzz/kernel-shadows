...
**Статус:** 🚧 рефакторинг v2.0 в работе — Seasons 1–7 пересобраны в атомарные серии
и покрыты воспроизводимыми тестами; Season 8 пока в исходном виде.
...
**Итого: 89 серий, `make check` зелёный.**
