...
> [`V2.0_UPGRADE_PLAN.md`](V2.0_UPGRADE_PLAN.md), история — в
...
- **Сплошная вычитка подряд** глазами студента — по опыту MOONLIGHT (§4.6 плана)
...
Соотношение 23/38/38 % — ровно то, чего требует §2A от сезона про
...
разбором §8.1: `s02e10` SSH-туннели (`~/.ssh/config`, 23/23), `s02e11` WireGuard
...
обе укладываются в бюджет §6.1 (211 и 207 строк README) и покрывают свои темы,
